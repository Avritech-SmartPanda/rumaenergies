...
if(isset($_POST['emailSent'])) {
	...
	try {
		...
		$mail->IsHTML(tRuma Energies - Powering Africa  		// Set email format to HTML

		$mail->CharSet = 'UTF-8';Ruma Energies - Powering Africa
...
<html>
	<head>
		...
		<title>Forms | Ruma Energies - Powering Africa</title>	

		<meta name="keywords" content="WebSite Template" />
		<meta name="description" content="Ruma Energies - Powering Africa">
		...
		<div class="body">
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index.html"><img alt="Ruma" width="100" height="48" data-sticky-width="82" data-sticky-height="40" data-sticky-top="0" src="img/logo-default-slim-dark.png"></a>
									</div>
								</div>
							</div>
					...
					<div class="container pt-lg-5 mt-5">
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								...
								<a href="#examples" data-hash data-hash-offset="0" data-hash-offset-lg="100" class="btn btn-gradient-primary btn-effect-4 font-weight-semi-bold px-4 btn-py-2 text-3">View Examples <i class="fas fa-arrow-down ms-1"></i></a>
			...
			<footer id="footer" class="bg-color-dark-scale-2 border border-end-0 border-start-0 border-bottom-0 border-color-light-3 mt-0">
				<div class="container text-center my-3 py-5">
					<a href="index.html">
						<img src="img/lazy.png" data-src="img/landing/logo.png" width="102" height="45" class="mb-4 appear-animation lazyload" alt="Ruma" data-appear-animation="fadeIn" data-appear-animation-delay="300">
					</a>
